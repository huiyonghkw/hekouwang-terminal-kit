...
<tr>
<td><img src="docs/images/cmp-ghostty-free.png" alt="免费版的 Ghostty：跟旁边的 iTerm2 各走各的"></td>
<td><img src="docs/images/cmp-ghostty-paid.png" alt="付费版的 Ghostty：跟 iTerm2 同色"></td>
</tr>
</table>
...
一句话：**免费版让你的 iTerm2 好看；付费版让这份色板走出 iTerm2**——Ghostty、Warp、
macOS 自带终端、`cat`、`git diff`、tmux、VS Code 全都跟着一起变。
...
是让终端值得被截图的东西，藏起来只会让免费版当不成广告。**付费卖的是我自己做的那两件事**——
从品牌 token 推导的四套主题，和「一份色板管住整条工具链」的那套生成器。

**想要付费版**：加微信 **`hekouwang`**（备注「终端套装」）。¥19.9，一年内更新免费 + 群内答疑，
...
<p align="center">
  <img src="docs/images/03-install.png" width="88%" alt="一条命令装齐">
</p>
...
<p align="center">
  <img src="docs/images/11-session.png" width="62%" alt="真机终端：eza 目录树 + bat 高亮 + z 跳目录">
</p>
...
<p align="center">
  <img src="docs/images/06-advanced.png" width="88%" alt="三个高级玩法">
</p>
...
<p align="center">
  <img src="docs/images/20-tmux.png" width="78%" alt="tmux -CC：SSH 断线后重连，长任务原样还在跑">
</p>
...
<p align="center">
  <img src="docs/images/21-triggers.png" width="78%" alt="Triggers：日志关键词自动标色">
</p>
...
<p align="center">
  <img src="docs/images/22-shell.png" width="78%" alt="Shell Integration">
</p>

### Ghostty / Warp / 自带终端的差异

<p align="center">
  <img src="docs/images/30-ghostty-parity.png" width="92%" alt="同一条命令配好的 iTerm2 与 Ghostty">
</p>
